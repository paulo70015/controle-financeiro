...
class TestAnoBloqueado:
    def test_travar_ano(self, page: Page):
        ...
        # O botao #btnTravarAno e criado dinamicamente por atualizarAbasVisao()
        # Aguarda ele aparecer
        try:
    ...
    def test_ano_bloqueado_esconde_botoes(self, page: Page):
        ...
        # Os campos de input devem estar disabled
